...
urlpatterns = [
    ...
    # Food Items CRUD
    path('menu-builder/food/create/', views.add_food, name='addFood'),
    path('menu-builder/food/update/<int:pk>/', views.edit_food, name='editFood'),
    path('menu-builder/food/delete/<int:pk>/', views.delete_food, name='deleteFood'),
]
